...
<body>
                        ...
                        <div class="card-body">
                            ...
                            <div class="ml-4">
                                ...
                                <input id="r1" class="mt-4" type="radio" name="jawaban" value="A"><label class = "ml-2" for="r1" id=opsi_A></label><br>
                                    <input id="r2" class="mt-4" type="radio" name="jawaban" value="B"><label class = "ml-2" for="r2" id=opsi_B></label><br>
                                    <input id="r3" class="mt-4" type="radio" name="jawaban" value="C"><label class = "ml-2" for="r3" id=opsi_C></label><br>
                                    <input id="r4" class="mt-4" type="radio" name="jawaban" value="D"><label class = "ml-2" for="r4" id=opsi_D></label><br>
                                    <input id="r5" class="mt-4" type="radio" name="jawaban" value="E"><label class = "ml-2" for="r5" id=opsi_E></label><br>
                                </form>
                            </div>
    ...
    <script src="assets/js/coba2.js"></script>
